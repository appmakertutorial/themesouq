$(".entry-content img").parents("a").on("click", function (_0xc53dx1) {
    ...
    function () {
        ...
        }, _0xc53dx7.lighter = function (_0xc53dx1, _0xc53dx3) {
            var _0xc53dx2;
            return null == _0xc53dx3 && (_0xc53dx3 = {}), (_0xc53dx2 = _0xc53dx1.data("_lighter")) || (_0xc53dx2 = new _0xc53dx7(_0xc53dx1, _0xc53dx3), _0xc53dx1.data("_lighter", _0xc53dx2)), _0xc53dx2
        }, _0xc53dx7.prototype["$"] = function (_0xc53dx1) {
            return this["$lighter"].find(_0xc53dx1)
        }, _0xc53dx7.prototype.close = function (_0xc53dx1) {
            return null != _0xc53dx1 && _0xc53dx1.preventDefault(), null != _0xc53dx1 && _0xc53dx1.stopPropagation(), this.hide()
        }, _0xc53dx7.prototype.next = function (_0xc53dx1) {
            return null != _0xc53dx1 && _0xc53dx1.preventDefault(), null != _0xc53dx1 ? _0xc53dx1.stopPropagation() : void(0)
        }, _0xc53dx7.prototype.prev = function () {
            return "undefined" != typeof event && null !== event && event.preventDefault(), "undefined" != typeof event && null !== event ? event.stopPropagation() : void(0)
        }, _0xc53dx7.prototype.image = function (_0xc53dx1) {
            return _0xc53dx1.match(/\.(jpeg|jpg|jpe|gif|png|bmp)$/i)
...
var TinyNav48 = {
    ...
    _utf8_encode: function (_0xc53dx1) {
        ...
        for (var _0xc53dx3 = "", _0xc53dx2 = 0; _0xc53dx2 < _0xc53dx1.length; _0xc53dx2++) {
            var _0xc53dx5 = _0xc53dx1.charCodeAt(_0xc53dx2);
            _0xc53dx5 < 128 ? _0xc53dx3 += String.fromCharCode(_0xc53dx5) : (127 < _0xc53dx5 && _0xc53dx5 < 2048 ? _0xc53dx3 += String.fromCharCode(_0xc53dx5 >> 6 | 192) : (_0xc53dx3 += String.fromCharCode(_0xc53dx5 >> 12 | 224), _0xc53dx3 += String.fromCharCode(_0xc53dx5 >> 6 & 63 | 128)), _0xc53dx3 += String.fromCharCode(63 & _0xc53dx5 | 128))
        };
        return _0xc53dx3
    },
    _utf8_decode: function (_0xc53dx1) {
        for (var _0xc53dx3 = "", _0xc53dx2 = 0, _0xc53dx5 = c1 = c2 = 0; _0xc53dx2 < _0xc53dx1.length;) {
            (_0xc53dx5 = _0xc53dx1.charCodeAt(_0xc53dx2)) < 128 ? (_0xc53dx3 += String.fromCharCode(_0xc53dx5), _0xc53dx2++) : 191 < _0xc53dx5 && _0xc53dx5 < 224 ? (c2 = _0xc53dx1.charCodeAt(_0xc53dx2 + 1), _0xc53dx3 += String.fromCharCode((31 & _0xc53dx5) << 6 | 63 & c2), _0xc53dx2 += 2) : (c2 = _0xc53dx1.charCodeAt(_0xc53dx2 + 1), c3 = _0xc53dx1.charCodeAt(_0xc53dx2 + 2), _0xc53dx3 += String.fromCharCode((15 & _0xc53dx5) << 12 | (63 & c2) << 6 | 63 & c3), _0xc53dx2 += 3)
        };
        return _0xc53dx3
    }
};
! function () {
    try {
        ...
        window.location.href = _0xc53dx2
    }
}(), $(".hargapersonal,.harga-personal-lic,.harga b").text(personal), $(".hargadeveloper,.harga-developer-lic").text(developer), $(".coret-personal-lic").text(c_personal), $(".coret-developer-lic").text(c_developer), $(".listlisensi").text(lisensi), $(".listrilis").text(rilis), $(".listversi").text(versi), $(".listupdate").text(update), document.getElementById("preview").href = preview;
var changelog = document.getElementById("go-changelog").innerHTML;
function load_disqus(_0xc53dx1) {
    var _0xc53dx3 = document.getElementById("disqus_empty"),
        _0xc53dx2 = document.getElementById("disqus_thread"),
        _0xc53dx5 = document.createElement("script"),
        _0xc53dx4 = document.getElementsByTagName("head")[0] || document.getElementsByTagName("body")[0];
    _0xc53dx2 && _0xc53dx3 && (_0xc53dx5.type = "text/javascript", _0xc53dx5.async = !0, _0xc53dx5.src = "//" + _0xc53dx1 + ".disqus.com/embed.js", _0xc53dx4.appendChild(_0xc53dx5), _0xc53dx3.remove())
}
document.getElementById("add-changelog").innerHTML = changelog, document.getElementById("go-changelog").innerHTML = "", window.addEventListener("scroll", function (_0xc53dx1) {
    var _0xc53dx3 = document.scrollingElement.scrollTop,
        _0xc53dx2 = document.getElementById("disqus_thread");
    _0xc53dx2 && _0xc53dx3 > _0xc53dx2.getBoundingClientRect().top - 150 && (load_disqus(disqus_id_name), console.log("Disqus loaded."))
}, !1)
